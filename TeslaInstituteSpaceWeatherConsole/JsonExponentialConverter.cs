...
namespace TeslaInstituteSpaceWeatherConsole
{
    public class JsonExponentialConverter : JsonConverter
    {
        ...
        {
            List<TeslaInstituteSpaceWeatherConsole.TeslaInstituteSpaceWeatherData.AceSwepam> list = 
                new List<TeslaInstituteSpaceWeatherConsole.TeslaInstituteSpaceWeatherData.AceSwepam>();
            TeslaInstituteSpaceWeatherConsole.TeslaInstituteSpaceWeatherData.AceSwepam item = 
                new TeslaInstituteSpaceWeatherConsole.TeslaInstituteSpaceWeatherData.AceSwepam();
            int i = -1;
            ...
            while (reader.Read())
            {
                ...
                {
                    list.Add(item);
                    item = new TeslaInstituteSpaceWeatherConsole.TeslaInstituteSpaceWeatherData.AceSwepam();
                    i = -2;
                }
                i++;
            } // end while

...
namespace TeslaInstituteSpaceWeather.WPF
{
    public class KP7DatConverter : JsonConverter
    {
        ...
        {
            List<TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.KP7day> list = new List<TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.KP7day>();
            TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.KP7day item = new TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.KP7day();
            int i = -1;
            ...
            while (reader.Read())
            {
                ...
                {
                    list.Add(item);
                    item = new TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.KP7day();
                    i = -2;
                }
                i++;
            } // end while

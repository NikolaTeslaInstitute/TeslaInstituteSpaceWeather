...
namespace TeslaInstituteSpaceWeather.WPF
{
    public class JsonExponentialConverter : JsonConverter
    {
        ...
        {
            List<TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.AceSwepam> list = new List<TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.AceSwepam>();
            TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.AceSwepam item = new TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.AceSwepam();
            int i = -1;
            ...
            while (reader.Read())
            {
                ...
                {
                    list.Add(item);
                    item = new TeslaInstituteSpaceWeather.WPF.TeslaInstituteSpaceWeatherData.AceSwepam();
                    i = -2;
                }
                i++;
            } // end while
